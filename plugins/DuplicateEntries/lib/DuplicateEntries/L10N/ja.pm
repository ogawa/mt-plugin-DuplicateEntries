...
our %Lexicon = (
'DuplicateEntries plugin allows you to duplicate Movable Type entries, pages, and templates.'
      => 'DuplicateEntriesプラグインを用いると、Movable Typeのブログ記事・ウェブページ・テンプレートを複製することができます。',
...
'ブログ記事とカテゴリの関連付けを設定できませんでした: [_1]',
    'Saving template failed: [_1]' =>
      'テンプレートの保存に失敗しました: [_1]',
    'No entry was selected to duplicate.' =>
      '複製するブログ記事が選択されていません。',
    'No template was selected to duplicate.' =>
      '複製するテンプレートが選択されていません。',
